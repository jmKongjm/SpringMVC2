...
<script>
function init()
//문서가 로드될 때 textarea를 접근하겠다.
{
	CKEDITOR.replace("content");
}
//오라클에 넣기를 요청하는 function, 오라클에 직접 넣지 x
//클라이언트 스크립트 언어인 자바스크립트는 원본소스가 사용자들의 pc로 다운받아져서
//실행되므로 보안처리가 불가능하다.
//따라서 서버에 요청만 할 수 있다. 
function regist()
{
	form1.method = "post"; //내용이 많기 때문에 post로 보내야 한다.
	//왜 내용이 많으면...?? 
...
<form name = "form1"> <!--   //어디서부터 어디까지 보낼 지, 논리적인 영역에만 관여한다.form태그는!! -->
